;; finality-shield-core.clar
;; Finality Shield - Decentralized Financial Settlement Protocol

;; This contract provides a secure, transparent mechanism for managing shared financial commitments
;; on the Stacks blockchain. It enables users to create financial groups, track expenses, 
;; allocate costs, and settle payments with granular control and cryptographic integrity.
